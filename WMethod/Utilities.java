...
public class Utilities{
  ...
  /* Function determines whether or not the test case contains a "yes"
   * it's just like the original runFSM method but with the output supressed.
   */
  
  public static boolean genOutputPattern(State [] FSM, int stateID, String input, String separator, String match) {
	  ...
	  // basically only need to return of the output pattern returns the "yes"
	    return outputPattern.contains(match);
  }
